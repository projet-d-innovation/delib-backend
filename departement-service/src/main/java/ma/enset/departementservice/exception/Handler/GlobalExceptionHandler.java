package ma.enset.departementservice.exception.Handler;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = DepartementAlreadyExistsException.class)
    public ResponseEntity<ExceptionResponseDTO> handleElementAlreadyExistsException(DepartementAlreadyExistsException e) {
    ...
    public ResponseEntity<ExceptionResponseDTO> handleElementNotFoundException(DepartementNotFoundException e) {
        return new ResponseEntity<>(
            ExceptionResponseDTO.builder()
