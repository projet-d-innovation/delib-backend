...
//                        .build()
//        );
        List<Permission> permissionList = IntStream.range(0, 10)
                .mapToObj(i -> Permission.builder()
                        .permissionId(i)
                        .permissionName(faker.name().name())
                        .path(faker.internet().url())
                        .method(faker.options().option("GET", "POST", "PUT", "DELETE"))
                        .build())
                .toList();
        ...
        List<Role> roleList = Arrays.asList(
                ...
                Role.builder()
                        ...
                        .build(),
                Role.builder()
                        .roleId("DIRECTEURADJOINT")
                        .roleName("Directeur adjoint")
                        .permissions(List.of(permissionList.get(0)))
                        .build(),
                Role.builder()
                        .roleId("SECRETAIREGENEARLE")
                        .roleName("Secretaire generale")
                        .permissions(List.of(permissionList.get(0)))
                        .build()
        );

        List<Utilisateur> utilisateurList = IntStream.rangeClosed(1, 30)
                .mapToObj(i ->
                        Utilisateur.builder()
