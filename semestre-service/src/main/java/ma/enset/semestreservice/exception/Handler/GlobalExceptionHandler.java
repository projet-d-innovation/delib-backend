package ma.enset.semestreservice.exception.Handler;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = SemestreAlreadyExistsException.class)
    public ResponseEntity<ExceptionResponseDTO> handleElementAlreadyExistsException(SemestreAlreadyExistsException e) {
    ...
    @ExceptionHandler(value = SemestreNotFoundException.class)
    public ResponseEntity<ExceptionResponseDTO> handleElementNotFoundException(SemestreNotFoundException e) {
        return new ResponseEntity<>(
            ExceptionResponseDTO.builder()
