        ...
        return builder.routes()
                ...
                .route(
                        r -> r.path("/api/v1/inscriptions-pedagogique/**")
                                ...
                                .filters(f -> f.rewritePath("/inscription-pedagogique-service/docs", "/v3/api-docs"))
                                .uri("lb://inscription-pedagogique-service")
                ).
                route(
                        r -> r.path("/api/v1/sessions-universitaire/**")
                                .or()
                                .path("/session-universitaire-service/docs")
                                .filters(f -> f.rewritePath("/session-universitaire-service/docs", "/v3/api-docs"))
                                .uri("lb://session-universitaire-service")
                )
                .build();
    }
}
